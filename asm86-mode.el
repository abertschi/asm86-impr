...
;;
(defvar asm86-mod-base-offset 4
...
(defvar asm86-assume-base-offset 4
...
(defvar asm86-extrn-base-offset 4
...
(defvar asm86-variable-base-offset 4
...
(defvar asm86-code-comment-base-offset 4    ; same as inst
  "*Indentation for a code comment (two semi-colons)")
(defvar asm86-inline-comment-base-offset 4
  "*Indentation for an inline comment (single semi-colon)")
(defvar asm86-inst-base-offset 4
...
(defvar asm86-blank-func-offset 4
  "*Indentation for a blank line")
(defvar asm86-label-func-offset 4
  "*Indentation for an ordinary code label")
(defvar asm86-header-comment-func-offset 4
  "*Indentation for a header comment (three semi-colons)")
(defvar asm86-code-comment-func-offset 4
  "*Indentation for a code comment (two semi-colons)")
(defvar asm86-inline-comment-func-offset 4
  "*Indentation for an inline comment (single semi-colon)")
(defvar asm86-inst-func-offset 4
  "*Indentation for any line with code")


;;; Keywords, etc. for syntax highlighting, using font-lock minor mode
;;; from https://github.com/emacs-mirror/emacs/blob/master/lisp/progmodes/asm-mode.el
